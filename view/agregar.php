...
<div class="uk-container uk-margin-large-top">
    <h1 class="uk-heading-medium">Agregar Fondos</h1>
    <form class="uk-form-stacked" action="../controllers/agregar.php" method="POST">
        <div class="uk-margin">
        ...
        <div class="uk-margin">
            <label class="uk-form-label" for="monto">Monto:</label>
            <div class="uk-form-controls">
                <input class="uk-input" id="monto" name="monto" type="number" placeholder="Monto" required>
            </div>
        </div>
        <div class="uk-margin">
            <button class="uk-button uk-button-primary" type="submit">Agregar Fondos</button>
        </div>
    </form>
</div>
